...
// ============================================================
const APP_CONFIG = {
    publicUrl: 'https://kapework.com/apps/make36/',
    shareLabel: 'Make 36'
};
...
const VALID_PUZZLES = [[5,6,7,9],[1,6,8,9],[4,8,9,9],[1,5,8,9],[4,6,6,7],[2,5,6,7],[1,3,3,4],[1,4,4,6],[1,1,6,9],[2,4,6,9],[1,5,6,7],[1,3,4,4],[1,1,5,8],[1,3,7,8],[2,4,4,6],[3,3,4,4],[2,3,4,4],[3,4,6,8],[6,8,8,9],[6,6,6,6],[4,6,6,9],[4,5,5,8],[1,5,7,8],[1,1,6,6],[2,6,6,6],[1,4,8,8],[4,4,4,6],[1,2,6,9],[2,4,4,7],[5,5,9,9],[1,4,5,9],[5,5,5,6],[1,2,4,5],[2,2,2,7],[3,5,7,8],[2,5,5,8],[3,4,5,7],[5,7,8,9],[1,4,6,8],[1,3,3,6],[3,3,7,9],[3,3,6,7],[1,3,4,8],[1,4,4,9],[2,2,3,4],[1,2,5,9],[2,3,3,9],[2,5,8,9],[2,2,7,8],[4,5,5,7],[3,6,6,6],[1,2,6,8],[2,6,6,7],[2,6,6,8],[1,2,5,6],[2,6,7,8],[2,4,6,7],[3,3,3,4],[5,5,5,9],[3,8,9,9],[3,4,4,7],[2,2,4,7],[3,7,7,8],[3,3,3,6],[3,6,7,9],[4,6,6,6],[1,2,6,7],[1,1,4,8],[3,4,6,9],[2,3,9,9],[2,2,3,8],[2,2,5,9],[3,3,3,9],[5,5,8,9],[4,6,9,9],[1,4,4,5],[4,4,5,5],[6,6,6,8],[3,9,9,9],[2,5,6,8],[3,3,4,6],[1,1,3,8],[2,2,3,5],[1,3,5,6],[1,6,6,8],[1,4,5,7],[2,4,5,8],[1,2,2,6],[2,4,7,7],[2,2,3,9],[3,3,3,5],[2,2,5,6],[1,4,5,5],[2,8,9,9],[5,6,6,9],[3,5,8,9],[1,4,6,9],[2,5,7,8],[4,5,5,9],[1,2,3,5],[3,4,7,9],[5,5,6,7],[2,4,6,8],[4,5,8,8],[2,4,7,8],[1,2,5,5],[4,5,6,8],[3,6,7,7],[1,3,4,7],[2,3,4,8],[2,3,4,5],[1,3,3,5],[1,2,3,4],[2,2,6,8],[3,3,5,7],[1,2,4,9],[5,6,6,8],[1,3,8,9],[1,3,6,7],[4,5,6,7],[1,2,5,7],[2,4,5,6],[2,4,7,9],[1,1,2,9],[1,2,3,6],[1,1,5,7],[6,6,6,9],[3,7,9,9],[3,6,6,9],[3,6,6,8],[1,3,5,8],[2,3,6,9],[1,2,4,8],[2,3,5,7],[2,5,5,7],[3,3,9,9],[4,4,5,6],[2,2,5,7],[2,4,5,7],[4,5,7,7],[1,6,9,9],[1,1,4,7],[1,7,8,9],[1,3,4,9],[1,2,8,8],[5,6,9,9],[1,3,4,5],[6,8,9,9],[2,2,4,9],[3,5,5,9],[4,4,8,8],[2,3,3,7],[4,4,4,8],[6,7,8,9],[1,3,6,6],[3,3,6,6],[4,7,7,8],[3,3,4,9],[2,2,4,5],[1,2,8,9],[3,4,4,5],[1,5,9,9],[2,4,4,9],[2,3,3,5],[3,6,8,9],[2,4,6,6],[3,4,5,8],[3,3,4,5],[1,2,3,7],[2,2,6,9],[2,3,8,9],[2,3,7,7],[2,5,5,9],[1,2,6,6],[3,4,5,6],[1,4,5,8],[1,3,6,8],[4,6,6,8],[3,3,8,9],[2,2,3,6],[2,4,8,9],[3,3,7,8],[4,5,7,9],[5,8,8,9],[2,7,8,8],[1,4,4,7],[3,3,3,7],[1,2,7,7],[1,3,3,9],[2,5,8,8],[1,2,4,7],[2,3,4,9],[1,3,9,9],[2,2,5,8],[3,3,3,8],[3,7,7,9],[4,5,8,9],[5,6,8,8],[2,3,3,3],[1,2,5,8],[2,3,5,9],[1,4,6,6],[3,5,5,6],[4,4,5,8],[1,1,5,5],[1,5,5,6],[1,3,5,7],[1,3,7,9],[2,2,4,4],[1,6,6,6],[1,1,4,9],[1,2,3,9],[2,5,6,6],[3,5,6,8],[4,4,4,9],[2,7,7,8],[3,5,5,8],[4,5,7,8],[2,3,7,8],[2,3,8,8],[3,4,6,6],[3,4,4,6],[4,4,4,5],[4,6,8,9],[2,3,7,9],[3,8,8,9],[4,4,7,8],[1,4,7,9],[4,6,8,8],[2,2,4,6],[6,6,8,9],[3,3,4,7],[5,6,7,8],[1,1,3,6],[4,6,7,9],[3,6,9,9],[4,7,8,8],[2,2,2,8],[1,2,7,8],[4,4,4,4],[2,4,4,5],[4,8,8,9],[2,5,6,9],[1,4,7,8],[2,3,4,6],[2,2,6,6],[3,3,5,6],[5,5,6,6],[4,6,7,8],[2,2,8,9],[2,4,4,8],[4,7,8,9],[2,3,6,6],[3,5,7,9],[3,4,4,9],[2,4,5,9],[2,6,6,9],[6,6,8,8],[2,2,8,8],[1,4,4,4],[4,5,6,6],[4,4,8,9],[3,7,8,9],[3,4,7,8],[3,5,9,9],[6,7,9,9],[3,4,4,8],[3,4,4,4],[5,7,8,8],[1,3,6,9],[2,2,6,7],[3,3,4,8],[4,7,9,9],[5,6,7,7],[2,8,8,9],[3,4,8,9],[3,3,3,3],[1,4,7,7],[2,3,6,8],[1,4,4,8],[3,3,5,9],[2,5,7,9],[2,4,8,8],[2,4,4,4],[2,6,8,9],[1,3,5,9],[2,3,3,6],[2,6,9,9],[4,4,6,8],[2,3,5,5],[3,5,6,9],[2,6,8,8],[2,3,5,6],[4,5,5,6],[1,3,3,7],[5,6,6,7],[5,5,7,8],[5,6,6,6],[1,2,4,4],[1,4,8,9],[2,3,6,7],[2,2,3,3],[1,1,4,6],[4,4,4,7],[2,3,3,8],[3,4,5,5],[2,4,9,9],[2,2,3,7],[4,5,6,9],[1,5,6,6],[1,1,3,9],[2,2,4,8],[3,3,6,9],[2,8,8,8],[1,1,6,8],[5,7,7,9],[3,5,6,7],[1,2,2,8],[1,2,2,9],[4,4,5,7],[1,3,3,3],[1,3,4,6],[1,2,7,9],[3,4,5,9],[2,6,7,9],[1,1,5,6],[1,3,3,8],[4,8,8,8],[1,2,4,6],[5,6,8,9],[1,1,5,9],[1,1,6,7],[1,1,7,7],[1,1,8,9],[1,1,9,9],[1,2,9,9],[1,4,9,9],[1,5,5,7],[1,5,5,8],[1,5,7,7],[1,6,6,7],[1,6,7,7],[2,2,2,6],[2,2,7,9],[2,2,9,9],[2,3,3,4],[2,5,9,9],[2,7,9,9],[2,9,9,9],[3,3,5,8],[3,4,6,7],[3,4,8,8],[4,4,5,9],[4,4,6,6],[4,4,6,7],[4,7,7,9],[4,9,9,9],[5,5,5,7],[5,5,6,9],[5,7,7,7],[5,7,7,8],[5,7,9,9],[5,8,9,9],[5,9,9,9],[6,6,6,7],[6,6,7,7],[6,6,7,8],[6,6,9,9],[6,7,7,7],[6,7,7,8],[6,7,8,8],[6,9,9,9],[7,8,9,9],[7,9,9,9],[9,9,9,9]];
...
// ============================================================
const NUDGE_DISMISSED_KEY = 'make36_sync_nudge_dismissed';
...
async function maybeShowSyncNudge() {
    ...
    const shownKey = `make36_nudge_shown_${streak}`;
                ...
                if (res.ok) {
                    ...
                    if (rows && rows.length > 0 && rows[0].device_id) {
                        ...
                        if (canonicalId !== localId) {
                            localStorage.setItem('make36_device_id', canonicalId);
            ...
            if (userRes.ok) {
                ...
                if (rows && rows.length > 0) {
                    ...
                    if (player.device_id && player.device_id !== gameState.deviceId) {
                        ...
                        localStorage.setItem('make36_device_id', player.device_id);
...
function generateHistoryImage() {
    ...
    ctx.fillText(`Make 36 \u2014 Last ${days} Days`, canvas.width / 2, 36);
...
function shareHistoryGrid() {
    ...
    const shareText = `Make 36 \u2014 Last ${HISTORY_SHARE_DAYS} Days\n${emojiGrid}\n\uD83D\uDD25 ${gameState.streak} | ${solved}/${HISTORY_SHARE_DAYS} solved\n${APP_CONFIG.publicUrl}`;

    canvas.toBlob(async (blob) => {
        if (blob && navigator.share && navigator.canShare) {
            const file = new File([blob], 'make36-history.png', { type: 'image/png' });
...
function shareChallenge() {
    ...
    let text = `\u2694\uFE0F Can you beat my Make 36?\n`;
...
function getDeviceId() {
    let id = localStorage.getItem('make36_device_id');
    if (!id) {
        id = 'dev_' + Math.random().toString(36).substr(2, 9) + Date.now().toString(36);
        localStorage.setItem('make36_device_id', id);
    }
    return id;
}
...
function generateShareText() {
    ...
    let text = `36 \u2014 ${formatPuzzleDateLong(currentPuzzle.puzzleNum)}\n`;
    text += `${opLine}\n`;
...
function updateShakeToggleUI() {
    ...
    const pref = localStorage.getItem('make36_shake');
...
function getIOSGuidanceHTML() {
    return `
        ...
        <ol class="guidance-steps">
            ...
            <li>Find <b>kapework.com</b> and enable <b>Motion & Orientation</b></li>
        </ol>
...
// Tutorial puzzle: [1, 2, 3, 4] → 4×3=12, 1+2=3, 3×12=36
const TUTORIAL_NUMBERS = [1, 2, 3, 4];
const TUTORIAL_STEPS = [
    // Step 0: tap first number
    { action: 'selectCard', targetValue: 4, tooltip: 'Tap the <span class="tutorial-highlight">4</span> card' },
    // Step 1: tap second number
    { action: 'selectCard', targetValue: 3, tooltip: 'Now tap the <span class="tutorial-highlight">3</span> card' },
    // Step 2: pick operator
    { action: 'selectOp', targetOp: '*', tooltip: 'Choose <span class="tutorial-highlight">&times;</span> to multiply them' },
    // Step 3: tap 1
    { action: 'selectCard', targetValue: 1, tooltip: 'Tap the <span class="tutorial-highlight">1</span>' },
    // Step 4: tap 2
    { action: 'selectCard', targetValue: 2, tooltip: 'Now tap <span class="tutorial-highlight">2</span>' },
    // Step 5: add
    { action: 'selectOp', targetOp: '+', tooltip: 'Choose <span class="tutorial-highlight">+</span> to add them' },
    // Step 6: tap result card (3)
    { action: 'selectCard', targetValue: 3, tooltip: 'Tap the <span class="tutorial-highlight">3</span> card (the result)' },
    // Step 7: tap 12
    { action: 'selectCard', targetValue: 12, tooltip: 'And finally tap <span class="tutorial-highlight">12</span>' },
    // Step 8: multiply for 36
    { action: 'selectOp', targetOp: '*', tooltip: 'Choose <span class="tutorial-highlight">&times;</span> to make 36!' },
];

function shouldShowTutorialHint() {
    if (localStorage.getItem('make36_tutorial')) return false;
...
function hideTutorialHelpBtn() {
    ...
    localStorage.setItem('make36_tutorial', '1');
}
